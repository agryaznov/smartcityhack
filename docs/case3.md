...
## Во время проведения мероприятия для решения задач будет осуществлён доступ по средству REST-API к программному обеспечению Alphalogic, где будут доступны сигналы в режиме эмуляции со следующих устройств:  
